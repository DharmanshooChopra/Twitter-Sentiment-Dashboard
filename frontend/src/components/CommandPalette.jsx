...
const COMMANDS = [
  ...
  { id:'forecast',  label:'View Forecast (Settings)', icon:TrendingUp,      action:'nav',    target:'forecast',   kbd:'G F' },
  ...
  { id:'telemetry', label:'AI Brain Telemetry (Settings)', icon:Activity,  action:'nav',    target:'telemetry',  kbd:'G T' },
  { id:'semantic',  label:'Semantic Engine & Embeddings (Settings)', icon:BrainCircuit, action:'nav', target:'semantic', kbd:'G X' },
